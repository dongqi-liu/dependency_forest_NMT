...
import random
import spacy
mylog = open('multi30k_notype_en_de_recode.log', mode = 'a',encoding='utf-8')
...
class Seq2SeqTransformer(nn.Module):
    ...
    def forward(self,
        ...
        # print("dependency_forest_outs 得到")
        # print(dependency_forest_outs.shape)
...
def save_model(score,best_score,model):
    if score > best_score:
        ...
        torch.save(checkpoint, 'multi30k_notype_en_de_ckpt_best.pt')
    return best_score
