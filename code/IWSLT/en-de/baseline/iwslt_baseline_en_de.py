...
import random
import spacy
mylog = open('iwslt_baseline_en_de_recode.log', mode = 'a',encoding='utf-8')
...
# token_transform[TGT_LANGUAGE] = get_tokenizer('spacy', language='de_core_news_lg')
...
def save_model(score,best_score,model):
    if score > best_score:
        ...
        torch.save(checkpoint, 'iwslt_baseline_en_de_ckpt_best.pt')
    return best_score
