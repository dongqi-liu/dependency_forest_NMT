...
SUPPORTED_DATASETS = {
    ...
    'URL': 'https://drive.google.com/uc?id=1tJ5kP0Q3N-6_svrkWjnykeg1Es7v23bb',
    '_PATH': '2015-01.tgz',
    'MD5': 'dc3b5b58f1b6bdce214d4255dba58a80',
...
DATASET_NAME = "IWSLT2015"
@_create_dataset_directory(dataset_name=DATASET_NAME)

@_wrap_split_argument(('train', 'valid', 'test'))
def IWSLT2015(root='.data', split=('train', 'valid', 'test'), language_pair=('en', 'zh')):
    ...
    iwslt_tar = os.path.join(root, SUPPORTED_DATASETS['_PATH'].split(".")[0], 'texts/en/zh', 'en-zh.tgz')
