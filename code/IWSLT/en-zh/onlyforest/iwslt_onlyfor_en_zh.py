...
from onlyfor_forest import dependency_forest
import onlyfor_encoder as dep
import datetime
import sacrebleu
...
import random
import spacy
mylog = open('iwslt_only_forest_en_zh_recode.log', mode = 'a',encoding='utf-8')
...
def save_model(score,best_score,model):
    if score > best_score:
        ...
        torch.save(checkpoint, 'iwslt_only_forest_en_zh_ckpt_best.pt')
    return best_score
