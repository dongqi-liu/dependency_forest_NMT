...
from obj_type import dependency_tree_with_obj_type
import type_encoder as dep
import datetime
import sacrebleu
...
import random
import spacy
mylog = open('iwslt_type_en_zh_recode.log', mode = 'a',encoding='utf-8')
...
def save_model(score,best_score,model):
    if score > best_score:
        ...
        torch.save(checkpoint, 'iwslt_type_en_zh_ckpt_best.pt')
    return best_score
...
def collate_fn(batch):
    ...
    dependency_forest_set = dependency_tree_with_obj_type(parser,src_batch_list,src_sample_list)
